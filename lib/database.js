...
module.exports = {
  ...
  /**
   * Updates a user's frequencies table with a new table, given the User ID and Team ID
   * which uniquely identifies a user.
   * @param {String} email
   * @param {String} newToken
   * @return {boolean} Returns true if successful, false if token already exists in database.
   */
  updateFrequencies: async function(email, frequencies) {
   
    User.findOneAndUpdate({$or: [{'email': email}]},
