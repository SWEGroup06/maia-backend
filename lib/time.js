...
module.exports = {
  ...
  compareTime(time1, time2) {
    const a = DateTime.fromISO(time1);
    const b = DateTime.fromISO(time2);
  ...
  normaliseDate(dateStr) {
    ...
    return new Date(`1 Jan 1970 ${date.getHours()}:${date.getMinutes()}:${date.getSeconds()}+00:00`).toISOString();
  },
};
