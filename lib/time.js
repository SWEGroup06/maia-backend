...
module.exports = {
  ...
  combineDateAndTime(dateISO, timeISO) {
    ...
    const time = DateTime.fromISO(timeISO, {zone: 'Europe/Paris'});
  ...
  generateTimeRangesForDaysOfWeek(dayOfWeek, startTimeRangeISO, endTimeRangeISO) {
    ...
    const diffstart = DateTime.fromISO(startTimeRangeISO).diff(DateTime.fromISO(startTimeRangeISO).startOf('minute'));
    startTimeRangeISO = DateTime.fromISO(startTimeRangeISO).plus(diffstart).toISO();
    console.log('startTimeRangeISO (rounded up to nearest minute): ' + startTimeRangeISO);
    console.log('endTimeRangeISO: ' + endTimeRangeISO);
    const diffend = DateTime.fromISO(endTimeRangeISO).diff(DateTime.fromISO(endTimeRangeISO).startOf('minute'));
    endTimeRangeISO = DateTime.fromISO(endTimeRangeISO).plus(diffend).toISO();
    console.log('endTimeRangeISO (rounded up to nearest minute): ' + endTimeRangeISO);
