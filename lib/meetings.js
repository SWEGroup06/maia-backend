...
const context = {
  ...
  async tp(googleEmail, oldTitle, oldDateTimeISO, newStartDateRangeISO, newEndDateRangeISO,
      newStartTimeRangeISO, newEndTimeRangeISO, newDayOfWeek, timeRangeSpecified) {
    ...
    const timeRangesForDaysOfWeek = (timeRangeSpecified ?
          TIME.generateTimeRangesForDaysOfWeek(newDayOfWeek, newStartTimeRangeISO, newEndTimeRangeISO) : null);
