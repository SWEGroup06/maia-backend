...
const context = {
  ...
  async sp(googleEmails, title, duration, startDateRangeISO, endDateRangeISO, startTimeRangeISO, endTimeRangeISO,
    ...
    // TODO: Merge const timeRangesForDaysOfWeek = TIME.generateTimeRangesForDaysOfWeek(dayOfWeek, startTimeRangeISO,
    // endTimeRangeISO);
    ...
    const description = {
      ...
      startDateRange: startDateRangeISO,
      endDateRange: endDateRangeISO,
      // TODO: After merge timeRangesForDaysOfWeek: timeRangesForDaysOfWeek,
    };
