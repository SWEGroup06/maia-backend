  ...
  updateMeeting(tokens, event, startDateTime, endDateTime) {
    ...
    if (description !== null) {
      description = JSON.stringify({
        flexible: description.flexible, category: description.category, startDateRange: description.startDateRange,
        endDateRange: description.endDateRange, startDate: startDateTime, endDate: endDateTime});
    } else {
      description = event.description;
    }
    console.log('rescheduled description: ', description);
    oauth2Client.setCredentials(tokens);
