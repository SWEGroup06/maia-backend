...
const context = {
  ...
  _parseDateRange(specificDate, dateRangeObj) {
    ...
    } else if (specificDate.stringValue !== "") {
      flexible = false;
      dateRange.start = DateTime.fromISO(specificDate.stringValue)
        .startOf("day")
        .toISO();
      dateRange.end = DateTime.fromISO(specificDate.stringValue)
        .endOf("day")
        .toISO();
    }
