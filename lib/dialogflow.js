...
const context = {
    ...
    cancel: function (fields) {
      return {
        ...
        meetingDateTime: TIME.combineDateAndTime(
          ...
          TIME.maintainLocalTimeZone(fields.time.stringValue)
        ),
      };
    },
   ...
   * @param {boolean} silent - Supress log messages
   ...
   */
  async sendQuery(msg, silent = false) {
    // Session id
    ...
    if (!silent) console.log("DIALOGFLOW:", res);
    return res;
  },
