...
const context = {
  _actionHandlers: {
    ...
    sp: function(fields) {
      ...
      const dateRange = context._parseDateRange(fields['specific-date'], fields['date-range']);
      ...
      return ({
        ...
        flexible: timeProperties.flexible,
  ...
  _parseTimeRange(specificTime, timeRangeObj) {
    ...
    const timeRange = {start: CURR_DATE_TIME.startOf('day').toISO(),
